...
Future<String?> promptForFocusName(BuildContext context) async {
    ...
    builder: (BuildContext dialogContext) {
      return AlertDialog(
        ...
        content: TextField(
          ...
          autofocus: true,
          decoration: const InputDecoration(hintText: "Enter focus name"),
        ),
        actions: [
          TextButton(
                ...
                child: Padding(
                  ...
                  child: Align(
                    ...
                    child: FloatingActionButton.small(
                      onPressed: () async {
                        final name = await promptForFocusName(context);
                        if (name != null) {
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: getColor(
                                    value.values.elementAt(index)["color"]),
                                borderRadius: BorderRadius.circular(20),
                              ),
                              child: Row(
                                children: [
